package com.randream.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.randream.bean.*;
import com.randream.code.Code;
import com.randream.mapper.RightMapper;
import com.randream.mapper.UserMapper;
import com.randream.mapper.UserRightRelationMapper;
import com.randream.service.interfaces.IUserService;
import com.randream.utils.DesUtil;
...
public class UserServiceServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    public Result Login(SoftLoginBean loginInfo) {//邮箱号手机号密码登录
